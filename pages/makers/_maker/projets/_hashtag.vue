...
import { defineComponent, useFetch, useContext, useRouter, useMeta } from '@nuxtjs/composition-api'
...
export default defineComponent({
  ...
  setup() {
    ...
    fetch()
    useMeta(() => ({
      title: projectData.value?.name || projectData.value?.hashtag || 'Pas de titre',
      meta: createMeta(
