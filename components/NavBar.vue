    ...
    <nav class="navbar navbar-light bg-transparent pr-0">
      ...
      <ul class="list-group list-group-horizontal">
        <li
          ...
          class="list-group-item bg-transparent border-0 text-white p-2 p-md-3 cursor-pointer"
