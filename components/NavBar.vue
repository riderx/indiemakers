    ...
    <div class="flex items-center justify-between px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
      ...
      <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
        ...
        <div class="flex items-center md:ml-12">
          <a href="/discord" class="inline-flex items-center justify-center px-4 py-2 ml-8 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-orchid-300 hover:bg-orchid-600">
            Communauté
          </a>
        </div>
      </div>
    ...
    <div v-if="menuMobile" class="absolute inset-x-0 top-0 z-10 p-2 transition origin-top-right transform md:hidden">
      <div class="bg-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
        ...
        <div class="px-5 py-6">
          ...
          <div class="mt-6">
            <a href="/discord" class="flex items-center justify-center w-full px-4 py-2 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-orchid-300 hover:bg-orchid-600">
              Communauté
            </a>
          </div>
        </div>
